        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CareerApplications_Careers_CareerId",
                        column: x => x.CareerId,
                        principalTable: "Careers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CareerApplications_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InMemoriams", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommitteeApplications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommitteeApplications_Elections_ElectionId",
                        column: x => x.ElectionId,
                        principalTable: "Elections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommitteeApplications_Positions_PositionId",
                        column: x => x.PositionId,
                        principalTable: "Positions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CommitteeApplications_Transactions_TransactionId",
                        column: x => x.TransactionId,
                        principalTable: "Transactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_CommitteeApplications_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventTickets_EventRegistrations_EventRegistrationId",
                        column: x => x.EventRegistrationId,
                        principalTable: "EventRegistrations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventTickets_Transactions_TransactionId",
                        column: x => x.TransactionId,
                        principalTable: "Transactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MembershipApplications_Transactions_TransactionId",
                        column: x => x.TransactionId,
                        principalTable: "Transactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CareerApplications_CareerId",
                table: "CareerApplications",
                column: "CareerId");

            migrationBuilder.CreateIndex(
                name: "IX_CareerApplications_UserId",
                table: "CareerApplications",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_CommitteeApplications_ElectionId",
                table: "CommitteeApplications",
                column: "ElectionId");

            migrationBuilder.CreateIndex(
                name: "IX_CommitteeApplications_PositionId",
                table: "CommitteeApplications",
                column: "PositionId");

            migrationBuilder.CreateIndex(
                name: "IX_CommitteeApplications_TransactionId",
                table: "CommitteeApplications",
                column: "TransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_CommitteeApplications_UserId",
                table: "CommitteeApplications",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventTickets_EventRegistrationId",
                table: "EventTickets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipApplications_TransactionId",
                table: "MembershipApplications",
                column: "TransactionId");
